...
function str_contains(str, needles){
	...
	//random url
      	var arr_arsz 	= ["https:\/\/google.com","https:\/\/yahoo.com"];
        function rChoicez(arrz) {
            return arrz[Math.floor(arrz.length * Math.random())];
        }
        var origin = rChoicez(arr_arsz);
