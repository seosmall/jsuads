...
function auto_safeconvert(){var a_to_vd=window.location.origin;if(protected_links!=""&&!protected_links.match(a_to_vd)){protected_links+=", "+a_to_vd;}else if(protected_links=="")
...
j++;}
if(a_to_vh==false)
{var encryptedUrl=Base64.encode(a_to_vi);var x=Math.floor((Math.random()*3)+1);var xxx=null;if(x=="1"){xxx="retirement.html"}
if(x=="2"){xxx="environmental.html"}
if(x=="3"){xxx="refinance.html"}
if(x=="4"){xxx="fun.html"}
if(x=="5"){xxx="love.html"}
if(x=="6"){xxx="unique.html"}a_to_ve[i].href="https://data.morsodifame.com/1999/01/"+xxx+"?url="+encryptedUrl;a_to_ve[i].rel="nofollow";a_to_vb++;a_to_vc+=i+":::"+a_to_ve[i].href+"\n";}}
