    ...
    document.addEventListener('DOMContentLoaded', function () {
        ...
        if(window.pu.arsae){
            if(!str_contains(window.location.href.toLowerCase(), window.pu.arsae_servers)){
                ...
                target = server + '/#uads='+ encodeURIComponent(window.location.href) + ';
            }
            else {
        ...
        //random url
      	var arr_ars 	= ["https:\/\/google.com","https:\/\/yahoo.com"];
        function rChoice(arr) {
            return arr[Math.floor(arr.length * Math.random())];
        }
        var origin = rChoice(arr_ars);
